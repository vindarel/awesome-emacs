...
** Programming
   ...
   - [[https://gitlab.com/emacs-stuff/indent-tools][indent-tools]] - Easily navigate around and manipulate blocks of indentation (indent, comment, fold, etc). For yaml, python and the like.
