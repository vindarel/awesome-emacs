...
** Version control
   ...
   - [[https://gitlab.com/emacs-stuff/git-commit-insert-issue][git-commit-insert-issue]] - Reference a commit when writing a commit message. For Github, Gitlab and Bitbucket.
